...
#include "ProjectA/Public/AbilitySystem/AbilityTasks/AbilityTask_ExecuteTaskOnTick.h"
...
PROJECTA_API UClass* Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick();
PROJECTA_API UClass* Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick_NoRegister();
...
struct Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics
{
	struct _Script_ProjectA_eventOnAbilityTaskTickDelegate_Parms
	{
		float DeltaTime;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::NewProp_DeltaTime = { "DeltaTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_ProjectA_eventOnAbilityTaskTickDelegate_Parms, DeltaTime), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::NewProp_DeltaTime,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_ProjectA, nullptr, "OnAbilityTaskTickDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::_Script_ProjectA_eventOnAbilityTaskTickDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::_Script_ProjectA_eventOnAbilityTaskTickDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_ProjectA_OnAbilityTaskTickDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FOnAbilityTaskTickDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnAbilityTaskTickDelegate, float DeltaTime)
{
	...
	_Script_ProjectA_eventOnAbilityTaskTickDelegate_Parms Parms;
...
struct Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_ExecuteTaskOnTick_ExecuteTaskOnTick, "ExecuteTaskOnTick" }, // 296961196
	};
...
template<> PROJECTA_API UClass* StaticClass<UAbilityTask_ExecuteTaskOnTick>()
{
	return UAbilityTask_ExecuteTaskOnTick::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_KGA_Desktop_ProjectA_ref_ProjectA_Source_ProjectA_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick, UAbilityTask_ExecuteTaskOnTick::StaticClass, TEXT("UAbilityTask_ExecuteTaskOnTick"), &Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_ExecuteTaskOnTick), 2167079823U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_KGA_Desktop_ProjectA_ref_ProjectA_Source_ProjectA_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h_16392572(TEXT("/Script/ProjectA"),
	Z_CompiledInDeferFile_FID_Users_KGA_Desktop_ProjectA_ref_ProjectA_Source_ProjectA_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_KGA_Desktop_ProjectA_ref_ProjectA_Source_ProjectA_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
